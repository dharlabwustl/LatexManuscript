...
\newsavebox\sahclusterfour\sbox\sahclusterfour{
    \begin{tikzpicture}

        \node (image1) [scale=1,inner sep = 0pt] at (0,0)  { \includegraphics[width=0.5\textwidth,height=0.5\textwidth]{../images/SAH_111_image5_forcluster.jpg}};

        \node (image2) [scale=1, right=of image1, inner sep = 0pt,xshift=-20,yshift=1]  { \scalebox{-1}[1]{\includegraphics[width=0.5\textwidth,height=0.5\textwidth]{../images/SAH_111_image2_forcluster.jpg}}};
        %ICH_0019_CT_20170123_AXIAL.png}};

        \node (image3) [scale=1, below=of image1, inner sep = 0pt,xshift=0,yshift=25] { \includegraphics[width=0.5\textwidth,height=0.5\textwidth]{../images/SAH_111_image3_forcluster.jpg
        }};

        \node (image4) [scale=1, below=of image2,  inner sep = 0pt,yshift=24]   { \includegraphics[width=0.5\textwidth,height=0.5\textwidth]{../images/SAH_111_image1_forcluster.jpg}};
...
\newsavebox\sahclusterthree\sbox\sahclusterthree{
    \begin{tikzpicture}

        \node (image1) [scale=1,inner sep = 0pt] at (0,0)  { \includegraphics[width=0.5\textwidth,height=0.5\textwidth]{../images/SAH_30_image1_forcluster.jpg}};

        \node (image2) [scale=1, right=of image1, inner sep = 0pt,xshift=-20,yshift=1]  { \scalebox{-1}[1]{\includegraphics[width=0.5\textwidth,height=0.5\textwidth]{../images/SAH_30_image2_forcluster.jpg}}};
        %ICH_0019_CT_20170123_AXIAL.png}};

        \node (image3) [scale=1, below=of image1, inner sep = 0pt,xshift=0,yshift=25] { \includegraphics[width=0.5\textwidth,height=0.5\textwidth]{../images/SAH_30_image3_forcluster.jpg
        }};

        \node (image4) [scale=1, below=of image2,  inner sep = 0pt,yshift=24]   { \includegraphics[width=0.5\textwidth,height=0.5\textwidth]{../images/SAH_30_05032014_1439_2_11.jpg}};
...
\newsavebox\sahclusterone\sbox\sahclusterone{
    \begin{tikzpicture}

        \node (image1) [scale=1,inner sep = 0pt] at (0,0)  { \includegraphics[width=0.5\textwidth,height=0.5\textwidth]{../images/SAH_231_image1_forcluster.jpg}};

        \node (image2) [scale=1, right=of image1, inner sep = 0pt,xshift=-20,yshift=1]  { \scalebox{-1}[1]{\includegraphics[width=0.5\textwidth,height=0.5\textwidth]{../images/SAH_231_image2_forcluster.png}}};
        %ICH_0019_CT_20170123_AXIAL.png}};

        \node (image3) [scale=1, below=of image1, inner sep = 0pt,xshift=0,yshift=25] { \includegraphics[width=0.5\textwidth,height=0.5\textwidth]{../images/SAH_231_image3_forcluster.png
        }};

        \node (image4) [scale=1, below=of image2,  inner sep = 0pt,yshift=24]   { \includegraphics[width=0.5\textwidth,height=0.5\textwidth]{../images/SAH_231_nifit.jpg}};
...
\newsavebox\sahclustertwo\sbox\sahclustertwo{
    \begin{tikzpicture}

        \node (image1) [scale=1,inner sep = 0pt] at (0,0)  { \includegraphics[width=0.5\textwidth,height=0.5\textwidth]{../images/SAH_232_image4_forcluster.jpg}};

        \node (image2) [scale=1, right=of image1, inner sep = 0pt,xshift=-20,yshift=1]  { \scalebox{-1}[1]{\includegraphics[width=0.5\textwidth,height=0.5\textwidth]{../images/SAH_232_image2_forcluster.jpg}}};
        %ICH_0019_CT_20170123_AXIAL.png}};

        \node (image3) [scale=1, below=of image1, inner sep = 0pt,xshift=0,yshift=25] { \includegraphics[width=0.5\textwidth,height=0.5\textwidth]{../images/SAH_232_image3_forcluster.jpg
        }};

        \node (image4) [scale=1, below=of image2,  inner sep = 0pt,yshift=24]   { \includegraphics[width=0.5\textwidth,height=0.5\textwidth]{../images/SAH_232_image1_forcluster.jpg}};
...
\newsavebox\clustersahcohort\sbox\clustersahcohort{
    \begin{tikzpicture}
        %		\node (clusterone) [yshift=-70,scale=0.7,below=of sniprlogo] {\usebox\clusterone};


        \node (image1) [scale=1,inner sep = 0pt] at (0,0)  {\usebox\sahclusterone};
        %	\node (image1_boundary) [rectangle,line width=1mm,draw=green!50, fit={ (image1)}] {};
        \node (image2) [scale=1, right=of image1, inner sep = 0pt,xshift=-18]  {\usebox\sahclusterthree};
        %	\node (image2_boundary) [rectangle,line width=1mm,draw=green!50, fit={ (image2)}] {};
        \node (image3) [scale=1, below=of image1, inner sep = 0pt,xshift=-18] {\usebox\sahclustertwo};
        %		\node (image2_boundary) [rectangle,line width=1mm,draw=green!50, fit={ (image3)}] {};
        \node (image4) [scale=1, below=of image2,  inner sep = 0pt,yshift=17]   {\usebox\sahclusterfour};
        %			\node (image2_boundary) [rectangle,line width=1mm,draw=green!50, fit={ (image4)}] {};
        %		\node (image5) [scale=1, below=of image2,  inner sep = 0pt,yshift=17] {\usebox\clusterone};
        %		%		\node (image2_boundary) [rectangle,line width=1mm,draw=green!50, fit={ (image5)}] {};
        %		\node (image6) [scale=1, below=of image3, inner sep = 0pt,yshift=17]   {\usebox\clusterone};
...
%% Cohorts 	\node(unclassifiedimages)[scale=0.5,yshift=400]  {\usebox\unclassifiedimages };
        ...
        \node (cluster3) [below=of clustertwo,yshift=-90,scale=0.4] {\usebox\clustersahcohort};
%% pre-classification image of a session
        ...
        \node (sahgraygroup) [scale=0.7,right=of cluster3,xshift=200] {\usebox\sahclusterthree};
...
%% connecting classified to segmentation
		...
		\draw[->, -stealth, line width=5mm,draw=violet, right of=ichgray] (sahgray) -- (sahseg) ;
...
%% connecting segmentation to biomarker quantification
		...
		\draw[->, -stealth, line width=5mm,draw=violet, right of=infarctseg] (csfseg3) -- (pdf3);
